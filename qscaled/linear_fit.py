...
def linear_fit_separate(utds_to_predict, df, df_best_lr_bs, save_path=None, plot=False):
    """
...
def linear_fit_shared(utds_to_predict, df, df_best_lr_bs, save_path=None, plot=False):
    utds_to_predict = np.array(utds_to_predict)
